...
type Screen = 'home' | 'suppliers' | 'rfqs' | 'tasks' | 'marketplace' | 'team' | 'profile' | 'contacts' | 'activity' | 'inbox';
...
function Workspace() {
  ...
  return (
    <div className="h-screen bg-gray-50 flex flex-col">
      <TopBar activeView={activeView} onViewChange={setActiveView} enableSettings={enableSettings} setEnableSettings={setEnableSettings} />
