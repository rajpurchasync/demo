...
export function HomeScreen({
  ...
  return (
    <div className="px-4 py-2 space-y-2 bg-gray-50 min-h-screen">
      ...
      {/* <div>
        <div className="flex space-x-2">
          <button
            ...
            className="flex-1 px-3 py-2 bg-white border border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-all duration-200 text-center"
          >
            <span className="text-xs font-medium text-gray-700">Manage Suppliers</span>
          </button>
          <button
            onClick={() => onScreenChange('rfqs')}
            className="flex-1 px-3 py-2 bg-white border border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-all duration-200 text-center"
          >
            <span className="text-xs font-medium text-gray-700">Manage Quotes</span>
          </button>
          <button
            onClick={() => onScreenChange('todos')}
            className="flex-1 px-3 py-2 bg-white border border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-all duration-200 text-center"
          >
      ...
      {/* Quick Actions Carousel - No Header */}
      <div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs opacity-90">
                Browse verified suppliers and get instant quotes
              </p>
            </div>
            <button
              onClick={() =>
                window.open("https://marketplace.purchasync.com", "_blank")
              }
