...
import { X, CheckSquare, Inbox, Users, FileText, Package, FileCheck, MessageCircle, User, UserPlus } from 'lucide-react';
...
export function HamburgerMenu({ isOpen, onClose }: HamburgerMenuProps) {
  ...
  const menuItems = [
    ...
    { id: 'suppliers', label: 'Supplier Management', icon: Users, color: 'text-purple-600' },
    { id: 'quotations', label: 'Quotations', icon: FileText, color: 'text-orange-600' },
    { id: 'samples', label: 'Samples', icon: Package, color: 'text-indigo-600' },
    { id: 'contracts', label: 'Contract', icon: FileCheck, color: 'text-red-600' },
