          ...
          <div className="border-t border-gray-200 pt-3 mt-3">
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-lg text-[#145434]">
                AED{" "}
                {data.apartmentType
                  ? (data.apartmentType === "studio"
                      ? 80
                      : data.apartmentType === "1br"
                      ? 120
                      : data.apartmentType === "2br"
                      ? 160
                      : 250) *
                      data.bookingHours +
                    (data.addOns?.ironing ? 15 * data.bookingHours : 0)
                  : 0}
              </span>
            </div>
          </div>
      ...
      {!data.repeatService && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h3 className="font-semibold text-[#145434] mb-1">
                Save Time & Money
              </h3>
