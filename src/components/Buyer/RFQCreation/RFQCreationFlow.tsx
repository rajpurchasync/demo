...
const RFQCreationFlow: React.FC = () => {
  ...
  const [rfqType, setRfqType] = useState<'product' | 'service' | 'project' | null>(null);
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Request for Quote</h1>
          <p className="text-gray-600">Create a new RFQ or use a saved template</p>
        </div>
