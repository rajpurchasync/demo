...
const NotificationsInterface: React.FC<NotificationsInterfaceProps> = ({
  sidebarCollapsed,
}) => {
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      message:
        "TechCorp Industries has submitted a quotation for Office Equipment RFQ.",
    ...
    },
    {
      ...
      message:
        "Global Supply Co. sent you a message regarding the IT Services contract.",
    ...
    },
    {
      ...
      message:
        "Marketing Campaign RFQ will expire in 2 days. Please review submissions.",
    ...
    },
    {
      ...
      message:
        "Your RFQ for Manufacturing Materials has been approved by the director.",
    ...
    },
    {
      ...
      message:
        "Emma Martinez has been added to the Procurement team as a Buyer.",
