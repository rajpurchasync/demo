...
import ContractTemplateCreateForm from "./ContractTemplateCreateForm";
...
const ContractTemplates: React.FC<RFQTemplatesProps> = ({
  sidebarCollapsed,
}) => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-white flex items-center justify-between p-4 py-3  lg:py-2 border-b border-gray-200">
        ...
        >
          <span className="hidden sm:inline">Create Contract Template</span>
        </button>
      </div>
