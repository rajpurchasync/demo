...
export function TeamManagementScreen() {
  ...
  const handleAddMember = () => {
    const member: TeamMember = {
      ...
      ...newMember,
      phone: '+971 50 000 0000', // Default phone for new members
      status: 'pending',
  ...
  return (
    <div className="px-3 py-2 space-y-3">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-sm font-bold text-gray-900">Team</h1>
      ...
      <div className="flex space-x-2 overflow-x-auto">
        {['All', 'Management', 'Sales', 'Operations', 'Finance'].map((dept) => (
          <button
            key={dept}
            className="px-3 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-600 hover:bg-gray-200 whitespace-nowrap"
          >
            {dept}
          </button>
        ))}
