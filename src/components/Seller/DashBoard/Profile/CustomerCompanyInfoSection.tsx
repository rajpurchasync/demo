...
interface CustomerCompanyInfoSectionProps {
  customer: Customer;
  onUpdate: (updates: Partial<Customer>) => void;
}

export function CustomerCompanyInfoSection({
  customer,
  onUpdate,
}: CustomerCompanyInfoSectionProps) {
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <span className="font-medium ml-2">{customer.type}</span>
                </div>
                <div>
                  <span className="text-gray-600">Category:</span>
                  <span className="font-medium ml-2">{customer.category}</span>
                </div>
              </div>
