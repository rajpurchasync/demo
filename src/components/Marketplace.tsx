              ...
              <div className="relative z-10">
                <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 lg:gap-0">
                  <div className="flex-1">
                    ...
                    <p className="text-green-100 mb-2 sm:mb-4 italic text-sm sm:text-base">
                      Environmental, Social & Ethical
                    </p>
                    <p className="text-xs sm:text-sm text-green-100 mb-4 sm:mb-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                {topCompanies.map((company, index) => (
                  <a href="/seller-page">
                    <div
                      key={index}
                      className="group border border-gray-200 rounded-lg p-3 sm:p-4 hover:shadow-md transition-all duration-200 hover:border-blue-200"
                    >
            ...
            <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
              ...
              <div className="space-y-3 sm:space-y-4">
                {trendingTags.map((tag, index) => (
                  ...
                  >
                    <div
                      className={`w-8 h-8 sm:w-10 sm:h-10 ${tag.color} rounded-lg flex items-center justify-center flex-shrink-0`}
                    >
