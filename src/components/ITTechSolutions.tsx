  ...
  const solutions = [
    {
      ...
      description:
        "Tailored e-commerce solutions and websites for hospitality businesses",
      features: [
        "Custom Design",
    ...
    },
    {
      ...
      title: "AI Agents",
      description:
        "Intelligent AI agents to enhance customer service and operations",
      features: [
        "Chatbots",
        "Virtual Assistants",
        "Automated Responses",
    ...
    <div className="min-h-screen bg-gray-50 pt-16 md:pt-28">
      ...
      <section className="py-16 bg-gradient-to-br from-indigo-50 via-blue-50 to-cyan-50 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div
            className="absolute bottom-20 right-10 w-40 h-40 bg-gradient-to-br from-blue-200/15 to-cyan-200/15 rounded-full blur-2xl animate-pulse"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
              Cutting-edge IT solutions designed to modernize and streamline
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Latest technologies and frameworks for robust hospitality
              solutions
            </p>
          </div>
