...
const SellerPage: React.FC<SellerPageProps> = () => {
  ...
  const sellerData = {
    ...
    clients: [
      ...
      {
        name: "Four Seasons",
        logo: "https://images.pexels.com/photos/3735747/pexels-photo-3735747.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&fit=crop",
      },
      {
        name: "Jumeirah Group",
    ...
    products: [
      {
        ...
        image:
          "https://images.pexels.com/photos/33783/olive-oil-salad-dressing-cooking-olive.jpg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop",
      ...
      },
      {
        ...
        image:
          "https://images.pexels.com/photos/3735747/pexels-photo-3735747.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop",
        ...
        <div className="bg-white rounded-2xl max-w-md w-full p-6">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">
              Chat with our intelligent sales assistant
            </p>
          </div>

          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            <p className="text-sm text-gray-600 mb-2">
              👋 Hi! I'm Anita, Emirates Food Solutions' AI assistant.
            </p>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-2xl max-w-lg w-full p-6">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">
              Get a custom quote from Emirates Food Solutions
            </p>
          </div>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-2xl max-w-lg w-full p-6">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">
              Contact Emirates Food Solutions directly
            </p>
          </div>
            ...
            {/* <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a
                    href={`https://${sellerData.contact.website}`}
