...
export function SupplierDetailScreen({ 
  ...
  const [showRequestDocumentModal, setShowRequestDocumentModal] = useState(false);
  const [expandedSections, setExpandedSections] = useState<string[]>(['licenses']);
      ...
      <div className="sticky top-0 bg-white border-b border-gray-100 z-10 shadow-sm">
        ...
        <div className="flex justify-center space-x-8 px-4 pb-4">
          ...
          >
            ...
            <span className="text-xs text-gray-700 font-medium">Set Meeting</span>
          </button>
