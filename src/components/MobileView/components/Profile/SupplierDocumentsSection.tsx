...
export function SupplierDocumentsSection({ documents, onUpdate }: SupplierDocumentsSectionProps) {
  ...
  const handleAddDocument = () => {
    if (newDocument.name) {
      const document: SupplierDocument = {
        ...
        attachmentUrl: `/docs/${newDocument.name.toLowerCase().replace(/\s+/g, '_')}.pdf`
      };
      ...
      <div className="p-4">
        ...
        <div className="space-y-3">
          {documents.map((document) => (
            <div key={document.id} className="p-3 border border-gray-200 rounded bg-white">
