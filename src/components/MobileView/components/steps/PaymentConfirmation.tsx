...
export function PaymentConfirmation({ data, pricing, onChange }: PaymentConfirmationProps) {
  ...
  const formatTime = (timeStr: string) => {
    ...
    const hour12 = parseInt(hour) > 12 ? `${parseInt(hour) - 12}:00 PM` : `${hour}:00 AM`;
    return hour12;
  };
  ...
  return (
    <div className="space-y-6">
      ...
      {data.paymentMethod === 'saved-cards' && (
        <div>
          <h3 className="text-md font-semibold text-gray-900 mb-4">Select Saved Card</h3>
                ...
                <div className="flex items-center justify-between">
                  <label className="flex items-center cursor-pointer flex-1">
                    <input
                      ...
                      onChange={(e) => onChange({ savedCardId: e.target.value })}
                      className="text-[#145434] focus:ring-[#145434]"
                    />
                    <div className="ml-3 flex-1">
                      <div className="flex items-center justify-between">
                        <div>
                          <div className="font-medium text-gray-900">{card.description}</div>
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <Input
              ...
              onChange={(e) => onChange({
                cardDetails: { ...data.cardDetails, holderName: e.target.value }
              })}
            />
            ...
            <div className="grid grid-cols-2 gap-4">
              <Input
                ...
                onChange={(e) => onChange({
                  cardDetails: { ...data.cardDetails, expiry: e.target.value }
                })}
              />
              <Input
                label="CVC"
      ...
      {data.paymentMethod === 'cash' && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h3 className="font-semibold text-blue-900 mb-1">Cash on Delivery</h3>
              <p className="text-sm text-blue-700">
                You can pay with cash when our cleaning professional arrives at your location. 
                Please have the exact amount ready: AED {pricing.total}
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Billing Information */}
      {(data.paymentMethod === 'new-card' || data.paymentMethod === 'saved-cards') && (
        <div>
      ...
      {data.paymentMethod !== 'cash' && (
        ...
        <p className="text-sm text-gray-600">
          Free cancellation until 3 hours before your booking. 
          50% cancellation charge applies within 3 hours of your scheduled service.
        </p>
        </div>
      )}
