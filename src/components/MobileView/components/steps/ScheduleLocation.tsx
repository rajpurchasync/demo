...
export function ScheduleLocation({ data, onChange }: ScheduleLocationProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Repeat Service</h2>
        <Toggle
        ...
        {data.repeatService && (
          <div className="mt-4">
            <h3 className="text-md font-medium text-gray-900 mb-3">Frequency</h3>
            <TileGrid
            ...
            {data.frequency && (
              <div className="mt-4">
                <h4 className="text-sm font-medium text-gray-900 mb-3">Preferred Weekdays</h4>
                <WeekdaySelector
                  selected={data.preferredWeekdays || []}
                  onChange={(weekdays) => onChange({ preferredWeekdays: weekdays })}
                />
              </div>
            )}
          </div>
      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <Input
            ...
            onChange={(e) => onChange({
              address: { ...data.address, parkingInstructions: e.target.value }
            })}
          />
        </div>
      </div>
