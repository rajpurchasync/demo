...
export function ServiceDetails({ data, onChange }: ServiceDetailsProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Cleaning Materials</h2>
        <RadioGroup
          options={materialOptions}
          selected={data.cleaningMaterials || 'needed'}
          onChange={(value) => onChange({ cleaningMaterials: value as 'needed' | 'not-needed' })}
          name="materials"
        />
      </div>
      ...
      <div>
        ...
        <Select
          ...
          value={data.bookingType === 'home' ? (data.apartmentType || '') : (data.officeSize || '')}
      ...
      {data.bookingType === 'home' && (
        <div>
          ...
          <div className="p-4 border-2 border-gray-200 rounded-lg">
            <div className="font-medium text-gray-900 mb-3">Ironing Service (AED 15 per hour)</div>
            <NumericStepper
