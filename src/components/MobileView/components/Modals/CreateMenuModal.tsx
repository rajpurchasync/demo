...
import { X, CheckSquare, FileText, Users, Package, FileCheck, FileSignature, CreditCard } from 'lucide-react';
...
export function CreateMenuModal({ isOpen, onClose }: CreateMenuModalProps) {
  ...
  const createOptions = [
    { id: 'scan-card', label: 'Scan a Card', icon: CreditCard, color: 'text-purple-600' },
