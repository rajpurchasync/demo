export interface Notification {
  ...
  title: string;
  message: string;
  type: 'rfq' | 'supplier' | 'sample' | 'contract' | 'team' | 'inbox';
  timestamp: string;
  isRead: boolean;
}
...
export const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    message: 'Ahmed Hassan has been added to your procurement team.',
    type: 'team',
  ...
  },
  {
    id: '5',
    title: 'New Message',
    message: 'You have a new message from FreshCo Vegetables.',
    type: 'inbox',
  ...
  },
  {
    ...
    message: 'Your sample request for Organic Tomatoes has been approved.',
    type: 'sample',
