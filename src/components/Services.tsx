...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description:
        "End-to-end procurement solutions including pre-opening, operational to strategic slurcing.",
      features: [
        "Sourcing Services",
        "Digital Procurement",
    ...
    },
    {
      ...
      description:
        "Growth-focused tools and strategies to expand your hospitality business reach and revenue.",
      features: [
        "Market Entry",
  ...
  return (
    <section id="services" className="py-8  md:py-10 bg-gray-50">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto px-4">
            Comprehensive solutions designed to simplify procurement and sales
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="flex flex-col items-center md:items-start group bg-white rounded-lg sm:rounded-xl lg:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 sm:hover:-translate-y-2"
            >
              ...
              <p className="text-center md:text-left text-xs sm:text-sm lg:text-base text-gray-600 mb-3 sm:mb-4 lg:mb-6 leading-relaxed">
                {service.description}
              </p>
