...
export function SettingsSection() {
  ...
  return (
    <div className="p-3 space-y-4">
      <h2 className="text-sm font-semibold text-gray-900 mb-3">Notification Settings</h2>

      {/* General Notifications */}
      <div className="space-y-3">
        <h3 className="text-xs font-medium text-gray-700 uppercase tracking-wide">General</h3>
