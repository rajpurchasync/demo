  ...
  const cards = [
    {
      title: "For Buyers",
      description:
        "One place for all your procurement and vendor management work.",
      details:
        "Scan business card, create tasks, run RFQ, manage supplier and collaborate with team in one app. Modular to fit for all.",
      image:
    ...
    },
    {
      ...
      details:
        "A connected workspace with CRM tools and Marketplace to collaborate seamlessly with your customers.",
      image:
          ...
          {cards.map((card, index) => (
            <div key={index} className="w-full flex-shrink-0 px-4">
              <div className="bg-white rounded-lg flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-500 mb-8">{card.details}</p>
              </div>
            </div>
          ))}
        </div>
